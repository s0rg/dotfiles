...
def make_keys():
    return [
        ...
        Key([variables.MOD, variables.CTRL], "Left",
            lazy.layout.grow_left(),
            desc="Grow window to the left"),
        Key([variables.MOD, variables.CTRL], "Right",
            lazy.layout.grow_right(),
            desc="Grow window to the right"),
        Key([variables.MOD, variables.CTRL], "Up",
            lazy.layout.grow_up(),
            desc="Grow window up"),
        Key([variables.MOD, variables.CTRL], "Down",
            lazy.layout.grow_down(),
            desc="Grow window down"),

        Key([variables.MOD, variables.CTRL], "n",
            lazy.layout.normalize(),
            desc="Reset all window sizes"),

        Key([variables.MOD, variables.CTRL], "r",
            lazy.restart(),
            desc="Restart Qtile"),

        # Movement between groups
        Key([variables.MOD], "Left",
            lazy.screen.prev_group(skip_empty=True),
            desc="Prev group"),
        Key([variables.MOD], "Right",
            lazy.screen.next_group(skip_empty=True),
            desc="Next group"),

        # Movement between windows
        Key([variables.MOD], "Up",
            lazy.group.next_window(),
            desc="Next window"),
        Key([variables.MOD], "Down",
            lazy.group.prev_window(),
            desc="Prev window"),

        # Utils
        Key([variables.MOD], "Return",
            lazy.spawn(variables.CMD_TERM),
            desc="Launch terminal"),
        Key([variables.MOD], "Tab",
            lazy.next_layout(),
        ...
        KeyChord([variables.MOD], "r", [
            ...
            Key([], "w",
                ...
                desc="Windows menu"),
            Key([], "q",
                lazy.spawn(rofioff.COMMAND),
                desc="Rofioff menu"),
            Key([], "f",
                lazy.spawn(rofifox.COMMAND),
                desc="Rofifox menu"),
        ], mode="rofi"),
...
def make_mouse():
    return [
        Drag([variables.MOD], "Button1",
             lazy.window.set_position_floating(),
             start=lazy.window.get_position()),
        Drag([variables.MOD], "Button3",
             lazy.window.set_size_floating(),
             start=lazy.window.get_size()),
        Click([variables.MOD], "Button1",
